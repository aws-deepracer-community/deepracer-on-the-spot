    ...
    <BaseAppLayout
      content={
        <TextContent>
          ...
          <p></p>
          <p>The <a href="/understanding_dots/base_resources">base resources stack</a> deploys a Security Group and updates a Network Access Control List (NACL), and it allows access from the IP address you specify when you deploy that stack.
