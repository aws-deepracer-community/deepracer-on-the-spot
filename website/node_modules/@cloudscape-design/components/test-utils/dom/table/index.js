...
const styles_selectors_js_6 = require("../../../table/expandable-rows/styles.selectors.js");
...
class TableWrapper extends dom_1.ComponentWrapper {
    ...
    findExpandToggle(rowIndex) {
        return this.findNativeTable().find(`tbody tr:nth-child(${rowIndex}) .${styles_selectors_js_6.default['expand-toggle']}`);
    }
    /**
