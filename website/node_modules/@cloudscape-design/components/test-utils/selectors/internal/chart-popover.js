...
class ChartPopoverSeriesItemWrapper extends selectors_1.ElementWrapper {
    findKey() {
        // If a series has sub-items and is expandable, the key will be inside the header of an expandable section.
        return (this.findByClassName(styles_selectors_js_4.default['header-text']) || this.findByClassName(styles_selectors_js_3.default.key));
    }
    findValue() {
